		...
		<center>
			<div class="page-header">
				...
				<form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-2 col-md-offset-2">
							<img class="img-responsive" src="./img/child1.png" alt="">
							<br><br>
							<button type="submit" class="btn btn-primary" name="A"> A </button>
						</div>

						<div class="col-md-2">
							<img class="img-responsive" src="./img/child2.png" alt="">
							<br><br>
							<button type="submit" class="btn btn-primary" name="B"> B </button>
						</div>	

						<div class="col-md-2 ">
							<img class="img-responsive" src="./img/child3.png" alt="">
							<br><br>
							<button type="submit" class="btn btn-primary" name="C"> C </button>
						</div>

						<div class="col-md-2">
							<img class="img-responsive" src="./img/child4.png" alt="">
							<br><br>
				...
				<div class="col-md-4 col-md-offset-4">
					...
					if (isset($_POST['A'])) 
					{
						$image_name = "./img/child1.png";
						game($image_name);
					}
					elseif (isset($_POST['B']))
					{ 
						$image_name = "./img/child2.png";
						game($image_name);
					}
					elseif (isset($_POST['C']))
					{ 
						$image_name = "./img/child3.png";
						game($image_name);
					}
					elseif (isset($_POST['D']))
					{ 
						$image_name = "./img/child4.png";
						game($image_name);
					}
					else
					{
		...
		for($x=0;$x<imagesx($soal1);++$x)
		{
			for($y=0;$y<imagesy($soal1);++$y)
			{
				...
				$index2 = imagecolorat($jawaban1, $x, $y);
						...
						// $gray1 = grayscale($index1);
						// $gray2 = grayscale($index2);
				...
				$blue3 = $blue3+($blue2-$blue);
						...
						// $greysoal = ($red+$green+$blue)/3;
						// $greyjawaban = ($red+$green+$blue)/3;

						// $x = $greysoal-$greyjawaban;
